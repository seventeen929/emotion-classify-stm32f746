...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 105216, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (105216)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (105216)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 59884, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (59884)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (59884)
