...
ai_buffer g_network_1_data_map_activations[AI_NETWORK_1_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 105216, 1, 1),
    105216, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_network_1_data_map_weights[AI_NETWORK_1_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 59884, 1, 1),
    59884, NULL, s_network_1_weights_array_u64),   /* weights_array */
  };
