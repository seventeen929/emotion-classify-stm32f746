...
__IO uint16_t Frame_Buffer[76800] __attribute__((at(0xC0000000)));
__IO uint16_t downImage[3136] __attribute__((at(0xC0200000)));
...
//		{
//			//downImage[j*56 + i] = Frame_Buffer[2560 + i*5 + j* 1200 ];
//			downImage[j*56 + i] = (Frame_Buffer[2560 + i*5 + j* 1200] + Frame_Buffer[2560 + i*5 + (j-1)*1200 ] + Frame_Buffer[2560 + i*5 + (j+1)*1200 ] + Frame_Buffer[2560 + (i+1)*5 + j*1200] + Frame_Buffer[2560 + (i-1)*5 + j*1200])/5;
//		}
//	}
			for(int j = 0 ; j < 56 ; j++)
		 {
			...
			{
			 //downImage[j*56 + i] = Frame_Buffer[2560 + i*5 + j* 1200 ];
			 downImage[j*56 + i] = (Frame_Buffer[11596 + i*3 + j* 795] + Frame_Buffer[11596 + i*3 + (j-1)*795 ] + Frame_Buffer[11596 + i*3 + (j+1)*795 ] + Frame_Buffer[11596 + (i+1)*3 + j*795] + Frame_Buffer[11596 + (i-1)*3 + j*795])/5;
			}
		 }
