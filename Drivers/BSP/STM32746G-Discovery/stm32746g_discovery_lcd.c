...
{     
  ...
  DrawProp[LayerIndex].BackColor = LCD_COLOR_WHITE;
  DrawProp[LayerIndex].pFont     = &Font24;
  DrawProp[LayerIndex].TextColor = LCD_COLOR_RED; 
}

void TEST_LCD_LayerRgb565Init(uint16_t LayerIndex, uint32_t FB_Address)
{     
  LCD_LayerCfgTypeDef  layer_cfg;

  /* Layer Init */
  layer_cfg.WindowX0 = 0;
	layer_cfg.WindowX1 = 56;
  layer_cfg.WindowY0 = 0;
  layer_cfg.WindowY1 = 56; 
	//layer_cfg.WindowY1 = 240;
  layer_cfg.PixelFormat = LTDC_PIXEL_FORMAT_RGB565;
  layer_cfg.FBStartAdress = FB_Address;
  layer_cfg.Alpha = 255;
  ...
  layer_cfg.BlendingFactor1 = LTDC_BLENDING_FACTOR1_PAxCA;
  layer_cfg.BlendingFactor2 = LTDC_BLENDING_FACTOR2_PAxCA;
  layer_cfg.ImageHeight = 56;
	layer_cfg.ImageWidth = 56;
  //layer_cfg.ImageHeight = 240;
...
void BSP_LCD_Clear1(uint32_t Color)
{ 
  /* Clear the LCD */ 
  LL_FillBuffer(1, (uint32_t *)(hLtdcHandler.LayerCfg[1].FBStartAdress), BSP_LCD_GetXSize(), BSP_LCD_GetYSize(), 0, Color);
}
...
void BSP_LCD_ClearStringLine(uint32_t Line)
{
  ...
  BSP_LCD_FillRect((uint32_t)0, (Line * DrawProp[ActiveLayer].pFont->Height), BSP_LCD_GetXSize(), DrawProp[ActiveLayer].pFont->Height);
...
void BSP_LCD_DisplayStringAt(uint16_t Xpos, uint16_t Ypos, uint8_t *Text, Text_AlignModeTypdef Mode)
{
  ...
  xsize = (BSP_LCD_GetXSize()/DrawProp[ActiveLayer].pFont->Width);//width=17,height=24
